                ...
                modal ? (
                    <div className='bg-black bg-opacity-25  w-full h-screen top-0 left-0 bottom-0 right-0 fixed backdrop-blur-sm !z-[9999]'>
                        <div className='flex justify-center items-center h-[100vh] container   '>
                            <div className='bg-white dark:bg-[#1D2144] rounded-lg lg:w-[600px] lg:h-[580px] xl:w-[800px] xl:h-[700px] 2xl:w-[800px] 2xl:h-[750px]'>
                                ...
                                <div className='md:p-7 md:pt-0 p-5 pt-0'>
                                    ...
                                    <div className='text-center mt-5'>
                                        ...
                                        <div className='mt-5 overflow-y-auto md:text-base text-sm h-40 md:h-36 xl:h-auto '>
                                            <p className='text-gray-500 text-justify lg:text-[12px] xl:text-[14px] 2xl:text-[16px]'>
                                                {desc}
                                            </p>
                                        </div>
                                    </div>
